		...
		for flight in os.listdir(spec_dir):
			...
			for station in os.listdir(f):
				...
				for image in os.listdir(sta):
					...
					spec_img = Image.open('/scratch/irseppi/nodal_data/plane_info/C185_spectrum_cfc/2019'+month[i]+day[i]+'/'+flight+'/'+station+'/'+station+'_' + str(time) + '.png')
					...
					BASE_DIR = '/scratch/irseppi/nodal_data/plane_info/C185_atm_2C/'
