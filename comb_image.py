...
for i in range(len(day)):
	#try:
	spec_dir = '/scratch/irseppi/nodal_data/plane_info/C185_spec_cfc_1o/2019-'+month[i]+'-'+day[i]
		...
		for flight in os.listdir(spec_dir):
			...
			for station in os.listdir(f):
				...
				for image in os.listdir(sta):
					...
					spec_img = Image.open('/scratch/irseppi/nodal_data/plane_info/C185_spectrum_cfc_1o/2019'+month[i]+day[i]+'/'+flight+'/'+station+'/'+station+'_' + str(time) + '.png')
					...
					BASE_DIR = '/scratch/irseppi/nodal_data/plane_info/C185_atmosphere_correction_new_1o/'
