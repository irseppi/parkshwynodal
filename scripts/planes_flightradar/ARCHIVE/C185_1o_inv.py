...
C185_output = open('output/C185data_cfc_1o.csv', 'a')
...
for li in file_in.readlines():
    ...
    spec_dir = '/scratch/irseppi/nodal_data/plane_info/C185_spec_cfc_1o/2019-0'+str(date[5])+'-'+str(date[6:8])+'/'+str(flight_num)+'/'+str(sta)+'/'
    ...
    BASE_DIR = '/scratch/irseppi/nodal_data/plane_info/C185_spec_cfc_1o/2019-0'+str(month)+'-'+str(day)+'/'+str(flight_num)+'/'+str(sta)+'/'
    ...
    BASE_DIR = '/scratch/irseppi/nodal_data/plane_info/C185_specrum_cfc_1o/20190'+str(month)+str(day)+'/'+str(flight_num)+'/'+str(sta)+'/'
    make_base_dir(BASE_DIR)
